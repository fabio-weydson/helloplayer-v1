...
import {
  arrowDown, heart, heartEmpty, skipBackward,
  play, pause, skipForward, removeCircleOutline
} from 'ionicons/icons';
...
const TrackControls = ({ playing, isFav, onPause, onPlay, onPrev, onNext, onFav }) => {
  ...
  <div className="track-controls">
    <IonIcon onClick={onFav} icon={isFav ? heart : heartEmpty} />
    <IonIcon onClick={onPrev} icon={skipBackward} />
    {playing.paused ? (
      <IonIcon onClick={onPlay} className="play-pause" icon={play} />
    ): (
      <IonIcon onClick={onPause} className="play-pause" icon={pause} />
    )}
    <IonIcon onClick={onNext} icon={skipForward} />
